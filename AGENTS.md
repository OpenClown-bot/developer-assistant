...
**Qodo PR-Agent** (GPT-5.3 Codex through OmniRoute) auto-reviews every PR; it is a **second** reviewer alongside Kimi, not a replacement. See `.pr_agent.toml` and `.github/workflows/pr_agent.yml` for its configuration.
